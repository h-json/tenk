...
- ⏭️ 다음 후보: **#28 잔여(ⓓ 8/30 ACME 갱신 확인 — 리마인더 걸어둠)** / **§0 잔여(Play 콘솔 폼 3종 + 데모 계정 + 아이콘 재업로드)** / iOS 빌드(맥 필요, 보류 — Sign in with Apple 4.8 요건 [decisions.md](decisions.md) 참고) / 페이지네이션 / 업적 시스템(최후순위).
---
